...
@php
    $links = [
        ...
        ['url' => '/admin/guides', 'match' => 'admin/guides*', 'label' => 'Guides', 'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5A4.5 4.5 0 003 9.5v9A4.5 4.5 0 017.5 14c1.746 0 3.332.477 4.5 1.253m0-9C13.168 5.477 14.754 5 16.5 5A4.5 4.5 0 0121 9.5v9a4.5 4.5 0 00-4.5-4.5c-1.746 0-3.332.477-4.5 1.253'],
        ...
        ['url' => '/admin/analytics', 'match' => 'admin/analytics*', 'label' => 'Analytics', 'icon' => 'M3 3v18h18M7 16l3-3 2 2 5-6'],
